...
def test_set_filters():
    from snovault.searches import set_filters
...
def test_set_facets():
    ...
    from snovault.searches import set_facets
    facets = [
        ('type', {'title': 'Type'}),
...
def test_format_facets():
    from snovault.searches import Base
    es_result = {
        'aggregations': {
            'field1': {
                'field1': {
