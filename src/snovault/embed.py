...
def _embed(request, path, as_user='EMBED'):
    ...
    # do this because we want the linked_uuids generated by @@embedded
    # for the @@audit view as part of the indexing process.
    # Will default to @@object linked_uuids if this
    # attr is not present (see item_view_audit in auditor.py)
    # don't run audits on rev_linked_uuids because for computational purposes
    if '@@audit' in path and hasattr(request, '_linked_uuids'):
            subreq._linked_uuids = request._linked_uuids
