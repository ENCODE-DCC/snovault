...
def _embed(request, path, as_user='EMBED'):
    ...
    # do this because we want the embedded_uuids generated by @@embedded
    # for the @@audit view as part of the indexing process.
    # Will default to @@object embedded_uuids if this
    ...
    # _embedded_uuids are populated in item_view_object of resource_views.py
    try:
